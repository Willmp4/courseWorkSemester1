...
public class bmiCalcJFrame extends JFrame {
	...
	public bmiCalcJFrame() {
		...
		calculate.addActionListener(new ActionListener() {
			// This is the logic for the caluclation
			public void actionPerformed(ActionEvent e) {
				if (!Height.getText().equals("") &&
						!Weight.getText().equals("")) {
					if (CheckNumber(Height.getText(), true) && // pass the input, true means float or int
		...
		BMIChart.addActionListener(new ActionListener() {
		...
		Metric.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				WeightLbl.setText("Enter Wegiht in KG");
		...
		Imperial.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				WeightLbl.setText("Enter Wegiht in Pounds");
